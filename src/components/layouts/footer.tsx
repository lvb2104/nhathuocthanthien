				...
				<div className='grid grid-cols-13 gap-8 mb-8'>
					...
					<div className='col-span-4'>
						...
						<ul className='space-y-2 text-sm '>
							<li>
								<Link href='#' className='cursor-pointer hover:text-[#7AB02C]'>
									Giới thiệu
								</Link>
							</li>
							<li>
							...
							<li>
								<Link
									href='#'
									className='cursor-pointer font-semibold text-(--primary-color) hover:text-[#7AB02C]'
								>
					...
					<div className='col-span-3'>
						...
						<p className='text-sm leading-relaxed'>
							...
							được tư vấn,
							<br />
							<Link href='#' className='cursor-pointer text-(--primary-color)'>
								Click xem chi tiết
							</Link>
						</p>
					</div>
