...
export const apiEndpoints = {
	...
	prescriptions: {
		getMy: '/prescriptions/me',
		getMyById: (id: number) => `/prescriptions/me/${id}`,
		getApproved: '/prescriptions/me/approved',
		getAllForPharmacist: '/prescriptions/pharmacist',
		create: '/prescriptions',
		approve: (id: number) => `/prescriptions/pharmacist/${id}/approve`,
		reject: (id: number) => `/prescriptions/pharmacist/${id}/reject`,
	},
	notifications: {
